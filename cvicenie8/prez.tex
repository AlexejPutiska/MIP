...
\title{Autopilov v robotických dronoch
}

\date{\footnotesize 7. november 2022}
...
Bežne sa aj tu používajú odrážky, ale tento text je naschvál uvedený bez odrážok. Niekedy môže byť po
...
\begin{frame}[fragile=singleslide]\frametitle{taoitnausgoanu}
\begin{itemize}
\item nUGABUKGBAGHUIASG
\item ASFSAFSAt -- \emph{zvýraznený text}
\item \emp{Kľúčová poznámka} % príkaz definovaný v preambule
...
\begin{frame}[fragile=singleslide]\frametitle{taoitnausgoanu}
\begin{itemize}
\item nUGasfsafGHUIASG
\item ASFSAFSAt -- \emph{zvýraznený text}
\item \emp{Prepisal saom tototoa} % príkaz definovaný v preambule
...
\includegraphics[scale=.35]{obrazok.jpg}
